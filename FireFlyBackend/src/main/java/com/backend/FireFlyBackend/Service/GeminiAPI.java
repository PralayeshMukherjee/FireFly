...
public class GeminiAPI {
    ...
    public Mono<Map<String, Object>> chat(String userMessage) {
        ...
        if(userMessage.contains("medicine")){
            formattedPrompt = "suggest medicine and give me response in 50-60 words: "+ userMessage;
            ...
            formattedPrompt = "what is the symptoms of and give me response in 50-60 words: "+userMessage;
